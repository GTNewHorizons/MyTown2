...
public class EconomyProxy {
    ...
    public static boolean isItemEconomy() {
        if (Config.instance.costItemName.get()
            .equals(Economy.CURRENCY_FORGE_ESSENTIALS)) {
            return false;
        } else if (Config.instance.costItemName.get()
            .equals(Economy.CURRENCY_VAULT)) {
                return false;
            } else if (Config.instance.costItemName.get()
                .startsWith(Economy.CURRENCY_CUSTOM)) {
                    return false;
                }
        return true;
    }

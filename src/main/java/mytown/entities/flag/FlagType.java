...
public class FlagType<T> implements Comparable<FlagType<T>> {
    ...
    public static final FlagType<Integer> MAXWARP;
    ...
    static {
        ...
        // Allows explosions
        EXPLOSIONS = new FlagType<Boolean>(
            "EXPLOSIONS",
            false,
            true,
            Property.IN_TOWN,
        ...
        // Maximum Total Warp from Thaumcraft allowed in order to enter town
        MAXWARP = new FlagType<Integer>("MAXWARP", 30, Property.IN_TOWN);

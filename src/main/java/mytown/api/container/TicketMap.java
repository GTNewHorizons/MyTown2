...
public class TicketMap extends HashMap<Integer, ForgeChunkManager.Ticket> {
        ...
        if (key instanceof Integer) {
            if (super.get(key) == null) {
                ...
                ForgeChunkManager.Ticket ticket = ForgeChunkManager
                    .requestTicket(MyTown.instance, world, ForgeChunkManager.Type.NORMAL);
                ticket.getModData()
                    .setString("townName", town.getName());
                ticket.getModData()
                    .setTag("chunkCoords", new NBTTagList());
    ...
    public void chunkLoad(TownBlock block) {
        ...
        NBTTagList list = ticket.getModData()
            .getTagList("chunkCoords", Constants.NBT.TAG_COMPOUND);
        list.appendTag(
            block.toChunkPos()
                .toNBTTagCompound());

...
public class ProtectionManager
{
  ...
  public static void check( EntityPlayerMP player )
  {
    ...
    if ( tHasPermissionToEnter )
      tWarpIsOK = ProtectionManager.checkWarpLevel( res,player.dimension, (int) Math.floor( player.posX ), (int) Math.floor( player.posY ), (int) Math.floor( player.posZ ) );

...
public class RanksConfig extends JsonConfig<Rank, Rank.Container> {
    ...
    public RanksConfig(String path) {
        ...
        this.gson = new GsonBuilder().registerTypeAdapter(Rank.class, new Rank.Serializer())
            .setPrettyPrinting()
            .create();
    }

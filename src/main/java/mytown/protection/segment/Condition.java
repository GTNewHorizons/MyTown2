    ...
    public boolean execute(Object object, Getter.Container getters) throws ConditionException, GetterException {
        ...
        for (int i = 0; i < conditionString.length; i += 4) {
            ...
            if (StringUtils.tryParseBoolean(conditionString[i + 2])) {
                boolean value = (Boolean) getters.get(conditionString[i])
                    .invoke(Boolean.class, instance, object);
                ...
                int value = (Integer) getters.get(conditionString[i])
                    .invoke(Integer.class, instance, object);
                if ("==".equals(conditionString[i + 1])) {
                ...
                float value = (Integer) getters.get(conditionString[i])
                    .invoke(Integer.class, instance, object);
                if ("==".equals(conditionString[i + 1])) {
                ...
                String value = (String) getters.get(conditionString[i])
                    .invoke(String.class, instance, object);
                if ("==".equals(conditionString[i + 1])) {
            ...
            if (conditionString.length <= i + 3 || current && "OR".equals(conditionString[i + 3])
                || !current && "AND".equals(conditionString[i + 3])) return current;

...
public class Config extends ConfigTemplate {
    ...
    public ConfigProperty<String> costItemName = new ConfigProperty<String>(
        ...
        GameRegistry.findUniqueIdentifierFor(Items.diamond)
            .toString());
    ...
    public ConfigProperty<Integer> costAdditionalChunkloadedUpkeep = new ConfigProperty<Integer>(
        "costAdditionalChunkloadedUpkeep",
        "cost",
    ...
    // @ConfigProperty(category = "extra", name = "debug", comment = "Enables debugging output to console, use '/ta
    // debug' to toggle ingame")

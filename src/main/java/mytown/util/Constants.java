...
public class Constants {
    ...
    public static final String EDIT_TOOL_NAME = EnumChatFormatting.BLUE + "Selector"; // TODO: Get localization for it,
                                                                                      // maybe?
    ...
    public static final String WHITELISTER_TOOL_DESCRIPTION_FLAG = EnumChatFormatting.DARK_AQUA + "Flag: "
        + FlagType.ACCESS.toString()
            .toLowerCase()
        + " & "
        + FlagType.ACTIVATE.toString()
            .toLowerCase();

...
public class PlotSellTool extends Tool {
    ...
    public PlotSellTool(Resident owner, int price) {
        super(
            owner.getPlayer(),
            LocalManager.get("myessentials.tool.name", LocalManager.get("mytown.tool.plot.sell.name"))
    ...
    protected String[] getDescription() {
        return LocalManager.get("mytown.tool.plot.sell.description", price, restricted)
    ...
    public void onShiftRightClick() {
        ...
        ChatManager.send(
            ...
            LocalManager.get("mytown.tool.plot.sell.property"),
            restricted);
    }
    ...
    protected boolean hasPermission(Town town, BlockPos bp) {
        ...
        if (!plot.ownersContainer.contains(owner) && !plot.getTown()
            .hasPermission(owner, "mytown.bypass.plot")) {
